...
# CheXpert constants
# #############################################
CHEXPERT_DATA_DIR = DATA_BASE_DIR / "../../chexpert/chexpertchestxrays-u20210408/CheXpert-v1.0"
...
# #############################################
MIMIC_CXR_DATA_DIR = DATA_BASE_DIR / "physionet.org/files/mimic-cxr-jpg/2.0.0"
...
MIMIC_CXR_MASTER_LA_CSV = MIMIC_CXR_DATA_DIR / "master_la1.csv"
MIMIC_CXR_FINAL_CSV = MIMIC_CXR_DATA_DIR / "final.csv"
MIMIC_CXR_ST_CSV = MIMIC_CXR_DATA_DIR / "st1.csv"
MIMIC_CXR_ALL_CSV = MIMIC_CXR_DATA_DIR / "all_text.csv"
MIMIC_CXR_IT_CSV = MIMIC_CXR_DATA_DIR / "Img_Textv1.csv"

MIMIC_CXR_TEM_TRAIN_JSON = MIMIC_CXR_DATA_DIR / "temporal_train_len4.json"
MIMIC_CXR_TEM_VAL_JSON = MIMIC_CXR_DATA_DIR / "temporal_val_len4.json"
...
# RSNA constants
# #############################################
RSNA_DATA_DIR = DATA_BASE_DIR / "datasets/RSNA_Pneumonia"
...
# #############################################
COVIDX_DATA_DIR = DATA_BASE_DIR / "datasets/COVIDx2/COVIDx"
